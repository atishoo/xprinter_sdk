...
/**
 this command sets the position of label under the pee-off mode.<br>
 OFFSET m<br>
...
/**
 this command moves the label's vertical position.<br>
 SHIFT n<br>
